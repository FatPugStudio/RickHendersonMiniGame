...
public class BossSpawner : MonoBehaviour
{
    ...
    {
        //iterate through each child and despawn a warpout effect for each child

        for (int i = 0; i < transform.childCount; i++)

        {
            warpOutTransform = this.gameObject.transform.GetChild(i);
            DarkTonic.CoreGameKit.PoolBoss.Despawn(warpOut.transform, false);
            DarkTonic.CoreGameKit.PoolBoss.Despawn(bossWarpWarning.transform, false);
        }
    }
